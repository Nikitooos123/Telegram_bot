...
async def start_game(message:Message):
    ...
    keyboard = ReplyKeyboardMarkup(keyboard=key0, resize_keyboard=True, one_time_keyboard=True)
...
async def help_command(message: Message):
    keyboard = ReplyKeyboardMarkup(keyboard=key1, resize_keyboard=True, one_time_keyboard=True)
...
async def start_game(message: Message):
    keyboard = ReplyKeyboardMarkup(keyboard=key2, resize_keyboard=True, one_time_keyboard=True)
...
@dp.message(Text(text=['Да', 'Давай', 'Сыграем', 'Игра', 'Играть', 'Хочу играть!'],
                 ignore_case=True))
async def process_game(message: Message):
    keyboard = ReplyKeyboardMarkup(keyboard=key3, resize_keyboard=True, one_time_keyboard=True)
...
async def process_numbers(message: Message):
    global ATTEMPS
    keyboard = ReplyKeyboardMarkup(keyboard=key4, resize_keyboard=True, one_time_keyboard=True)
    if users[message.from_user.id]['in_game']:
